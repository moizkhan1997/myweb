    ...
    <section id="viral-hits" className="relative min-h-[100svh] w-full overflow-hidden bg-[#08090d] text-white">
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col justify-center px-6 pt-32 pb-20 sm:px-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-base text-white/75 sm:text-lg">{data.hero.subtitle}</p>
    ...
    <section id="pricing" className="px-4 py-24 sm:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {data.plans.map((p) => (
            <div key={p.title}
              className={`relative flex flex-col rounded-3xl border bg-white p-8 transition hover:-translate-y-1 hover:shadow-2xl ${p.popular ? "border-[color:var(--ink)] shadow-xl ring-2 ring-[color:var(--ink)]" : "border-black/10"}`}>
              {p.popular && (
              ...
              <a href="#contact" className="mt-6 inline-flex justify-center rounded-full bg-[color:var(--ink)] px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90">
                Book a Call
              </a>
    ...
    <section id="testimonials" className="px-4 py-24 sm:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          {stats.map((s) => (
            <span key={s} className="rounded-full border border-black/15 bg-white px-5 py-2 text-sm font-semibold">{s}</span>
          ))}
        </div>
      </div>
    ...
    <section id="contact" className="px-4 py-28 sm:px-10 sm:py-36">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <a href="#contact" className="rounded-full bg-[color:var(--ink)] px-7 py-4 text-base font-semibold text-white transition hover:opacity-90">
            Start a Project →
          </a>
          <a href="#contact" className="rounded-full border-2 border-[color:var(--ink)] px-7 py-4 text-base font-semibold text-[color:var(--ink)] transition hover:bg-[color:var(--ink)] hover:text-white">
