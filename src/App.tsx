        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            <h1 className="font-display mt-6 text-[clamp(2.75rem,7vw,6.5rem)] leading-[0.95]">
              ...
              <br />into{" "}
              <span className="text-gradient-brand">'damn'</span>{" "}brands.
            </h1>
          ...
          <div className="lg:col-span-5">
            <div className="grid grid-cols-6 grid-rows-6 gap-3 h-[560px] md:h-[620px]">
              ...
              <div className="col-span-2 row-span-3 rounded-3xl overflow-hidden">
                <img src={work2} alt="Work 2" className="h-full w-full object-cover" loading="lazy" />
              </div>
              <div className="col-span-2 row-span-3 rounded-3xl overflow-hidden">
                <img src={work1} alt="Work 1" className="h-full w-full object-cover" loading="lazy" />
              </div>
              <div className="col-span-2 row-span-3 rounded-3xl overflow-hidden">
                <img src={work3} alt="Work 3" className="h-full w-full object-cover" loading="lazy" />
              </div>
    ...
    <section id="services" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((s, i) => (
            <article key={s.t} className="group relative rounded-3xl border border-border bg-card p-7 overflow-hidden transition hover:-translate-y-1 hover:shadow-soft">
              ...
              <div className="relative mt-4 text-xs font-medium uppercase tracking-widest text-muted-foreground">0{i + 1} / 0{services.length}</div>
            </article>
          ))}
        </div>
      </div>
  ...
  return (
    <section id="contact" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="font-display mt-4 text-5xl md:text-7xl leading-[1.2]">
          Got an idea worth{" "}
          <span
            className="font-serif-italic font-normal text-gradient-brand inline-block"
